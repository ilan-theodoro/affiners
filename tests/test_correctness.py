...
def identity_matrix_3x3():
    """Identity transformation matrix (3x3)."""
    return np.eye(3, dtype=np.float64)


@pytest.fixture
def identity_matrix():
    """Identity transformation matrix (4x4 homogeneous)."""
...
@pytest.fixture
def shear_matrix(shear_matrix_3x3, translation_offset):
    """Shear transformation matrix (4x4 homogeneous with translation)."""
    return make_homogeneous(shear_matrix_3x3, translation_offset)


@pytest.fixture
def rotation_matrix_3x3():
...
@pytest.fixture
def rotation_matrix(rotation_matrix_3x3, translation_offset):
    """Rotation transformation matrix (4x4 homogeneous with translation)."""
    return make_homogeneous(rotation_matrix_3x3, translation_offset)
...
class TestU8VsF32:
    ...
    def _compare_u8(self, result_u8, input_u8, matrix, margin=5):
    ...
    def test_identity_transform(self, small_volume_u8, identity_matrix):
        ...
        result_u8 = affiners.affine_transform_u8(small_volume_u8, identity_matrix)
        self._compare_u8(result_u8, small_volume_u8, identity_matrix, margin=2)

    def test_shear_transform(self, small_volume_u8, shear_matrix):
        """Shear transform u8 should be close to f32."""
        result_u8 = affiners.affine_transform_u8(small_volume_u8, shear_matrix)
        self._compare_u8(result_u8, small_volume_u8, shear_matrix, margin=10)

    def test_rotation_transform(self, small_volume_u8, rotation_matrix):
        """Rotation transform u8 should be close to f32."""
        result_u8 = affiners.affine_transform_u8(small_volume_u8, rotation_matrix)
        self._compare_u8(result_u8, small_volume_u8, rotation_matrix, margin=8)

    def test_medium_volume(self, medium_volume_u8, shear_matrix):
        """Test u8 on medium-sized volume."""
        result_u8 = affiners.affine_transform_u8(medium_volume_u8, shear_matrix)
        self._compare_u8(result_u8, medium_volume_u8, shear_matrix, margin=15)

    def test_cval_handling(self, small_volume_u8, identity_matrix_3x3):
...
class TestEdgeCases:
    ...
    def test_small_volume(self, identity_matrix, identity_matrix_3x3):
